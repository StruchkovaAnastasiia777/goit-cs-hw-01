...
class Parser:
    ...
    def factor(self):
        """
        Парсер для факторів: цілі числа або вирази в дужках.
    ...
    def term(self):
        """
        Парсер для термів: множення та ділення.
...
class Interpreter:
    ...
    def visit_BinOp(self, node):
        if node.op.type == TokenType.PLUS:
            ...
            return self.visit(node.left) / divisor
...
def main():
    print("Розширений інтерпретатор з підтримкою +, -, *, /, дужок")
    print("Приклади: 2+3*4, (2+3)*4, 10/2-1")
    print()
